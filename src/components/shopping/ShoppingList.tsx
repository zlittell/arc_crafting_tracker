...
export function ShoppingList({ shoppingList, collected, onSetCollected, onClearCollected, onRefineMaterial }: Props) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-4 pb-3 border-b border-gray-700">
        <div>
          <span className="text-sm text-gray-400">
            {collectedCount}/{totalCount} materials collected
          </span>
          <div className="mt-1 h-1.5 bg-gray-700 rounded-full w-full">
            <div
